...
function calc() {
  ...
  // Инициализация параметров калькулятора на основе localStorage
...
/* harmony import */ var _services_services__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(/*! ../services/services */ "./js/services/services.js");
...
function modal(triggerSelector, modalSelector, modalTimerId) {
  var btnOpenModal = document.querySelectorAll(triggerSelector),
...
function slider(_ref) {
  ...
  var slides = document.querySelectorAll(slide),
    ...
    // нужен для создания динамических точек слайдера
  ...
  function totalSlides(totalSlides, currentSlide) {
    if (totalSlides.length < 10) {
      total.textContent = "0".concat(totalSlides.length);
  ...
  function currentSlides(currentSlides) {
    if (currentSlides < 10) {
      current.textContent = "0".concat(currentSlides);
    } else {
  ...
  function transformSlide(wrapper, offset) {
    wrapper.style.transform = "translateX(-".concat(offset, "px)");
  }
...
function tabs(tabsSelector, tabsContentSelector, tabsParentSelector, activeClass) {
  ...
  function showTabContent() {
    ...
    // Параметр по умолчанию (стандарт ES6)
...
window.addEventListener('DOMContentLoaded', function () {
  ...
  (0,_modules_timer__WEBPACK_IMPORTED_MODULE_2__["default"])('.timer', 'June 20, 2023');
